...
from day_5.celery_task import pay_order
from day_5.models import PaymentLog, Payment, OrderStatus, Order, PaymentStatus, ProviderType
from day_5.services.OrderService import OrderService
...
class PayPaymentSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        payment_task = pay_order.delay(validated_data['payment_id'])
        return {"task_status": payment_task.status}
